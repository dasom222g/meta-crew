...
const saleABI: AbiItem[] = [
  ...
  {
    inputs: [],
    name: 'mintMetaAidToken',
    outputs: [
      {
        internalType: 'contract MintMetaAidToken',
        name: '',
        type: 'address',
      },
    ],
